...
## Features
- [**User Authentication**]([https://github.com/JakePatolilic/vsulib-ms/blob/main/User%20Authentication](https://github.com/JakePatolilic/vsulib-ms/blob/main/User%20Authentication.md)): Capability to identify different users for different roles.
